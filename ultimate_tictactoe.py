...
class Game(AbstractGame):
    ...
    def step(self, action):
        ...
        """
        Action(symbol=self.next_symbol, index=action)

        def execute(self, action: Action, verify: bool = True)
    ...
    def legal_actions(self):
        ...
        """
        return self.env.get_legal_indexes()
...
#         if self.board.is_result_O() or self.board.is_result_X():
#             return True
#
#         return False
#
